...
@WebServlet(name = "ServletArticleModifier",urlPatterns = {"/ArticleModifier"})
public class ServletArticleModifier extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // execution methode
        article.modificationArticle(changement,"Art_des");
